    ...
    return (
        <div className="min-h-screen bg-white dark:bg-[#0f151c] py-12 font-['public-sans',sans-serif]">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    {favorites.length > 0 && (
                        <button 
                            ...
                            className="px-4 py-2 text-sm font-semibold text-red-500 hover:text-gray-900 dark:text-white border border-red-500 hover:bg-red-500/100/100 rounded-lg transition-colors flex items-center gap-2"
                        >
                            <Trash2 size={16} />
                            Clear All
                        </button>
                ...
                {favorites.length === 0 ? (
                    <div className="bg-white dark:bg-[#0B0F15] rounded-2xl p-12 text-center border border-gray-200 dark:border-white/5 shadow-sm flex flex-col items-center justify-center min-h-[400px]">
                        ...
                        <p className="text-gray-500 dark:text-[#7C94B0] mb-8 max-w-md mx-auto">Found something you like? Tap the heart icon on any product to save it here for later.</p>
                        <Link href="/Home" className="px-8 py-3.5 bg-[#0F172A] text-gray-900 dark:text-white font-bold rounded-xl hover:bg-[#1e293b] transition-colors shadow-lg">
                            Explore Products
                        </Link>
                    </div>
                ) : (
                        ...
                        {favorites.map((product) => {
                            ...
                            return (
                                <Link
                                    ...
                                    key={product.id}
                                    className="group flex flex-col bg-white dark:bg-[#0B0F15] rounded-2xl border border-gray-200 dark:border-white/5 p-4 transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.06)] hover:-translate-y-1 hover:border-red-100 relative cursor-pointer block"
                                >
                                    <div className="relative w-full aspect-square bg-white dark:bg-[#0f151c] rounded-xl mb-5 overflow-hidden flex items-center justify-center mix-blend-multiply">
                                        ...
                                        <button 
                                            ...
                                            className="absolute top-3 right-3 z-10 w-8 h-8 rounded-full shadow-sm flex items-center justify-center transition-all bg-red-500/10 text-red-500 hover:bg-white dark:bg-[#0B0F15] hover:text-gray-500 dark:text-[#7C94B0] group/fav"
                                    ...
                                    <div className="flex flex-col flex-grow">
                                        ...
                                        <div className="flex flex-col mt-auto gap-4">
                                            ...
                                            <button 
                                                ...
                                                className={`w-full py-2.5 rounded-xl flex items-center justify-center gap-2 font-bold text-sm shadow-md transition-all duration-200 active:translate-y-0.5 ${inCart ? 'bg-emerald-100 text-[#10B981] border border-emerald-200 hover:bg-emerald-200 cursor-default' : 'bg-[#0f172a] text-gray-900 dark:text-white hover:bg-[#1e293b] hover:shadow-lg'}`}
                                            >
                                                {inCart ? (
