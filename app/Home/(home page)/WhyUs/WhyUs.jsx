...
export default function WhyUs() {
    return (
        <>
            {/* ── TRUST BADGES ── */}
            <section className="py-14" style={{borderTop:'1px solid rgba(139,92,246,0.1)',borderBottom:'1px solid rgba(139,92,246,0.1)',background:'linear-gradient(90deg, rgba(7,8,15,1) 0%, rgba(13,14,26,1) 50%, rgba(7,8,15,1) 100%)'}}>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                        {TRUST.map((item) => (
                            <div key={item.title} className="flex flex-col items-center text-center gap-3 p-5 rounded-2xl transition-all duration-300 group"
                                ...
                                onMouseEnter={e=>{e.currentTarget.style.background='rgba(255,255,255,0.04)';e.currentTarget.style.borderColor=`${item.color}40`;e.currentTarget.style.transform='translateY(-2px)'}}
