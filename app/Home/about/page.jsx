    ...
    return (
        <div className="bg-white dark:bg-[#0B0F15] font-['public-sans',sans-serif]">
            ...
            <main className="max-w-4xl mx-auto w-full px-6 py-16 md:py-24 animate-[fadeIn_0.5s_ease-out]">
                ...
                <div className="bg-white dark:bg-[#0B0F15] rounded-3xl p-8 md:p-12 shadow-lg shadow-gray-200/40 border border-gray-200 dark:border-white/5">
                    <div className="space-y-8 text-[#475569] leading-relaxed text-base md:text-lg">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-10 bg-emerald-50 rounded-2xl p-6 md:p-8 border border-emerald-100/50">
                            <div>
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Our Promise</h3>
                ...
                <div className="mt-16 flex flex-col items-center">
                    ...
                    <Link href="/Home" className="inline-block px-10 py-4 bg-[#0F172A] text-gray-900 dark:text-white font-bold rounded-xl shadow-[0_8px_30px_rgba(15,23,42,0.2)] transition-all hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(15,23,42,0.3)] hover:bg-[#1e293b]">
