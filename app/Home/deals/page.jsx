...
export default function Deals() {
    ...
    return (
        <div className="bg-[#F8FAFC] pb-20 font-['public-sans',sans-serif]">
            {/* Hero Section */}
            <section className="bg-orange-500 py-16 md:py-24 overflow-hidden relative">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-12">
                        <div className="flex-1 text-white text-center md:text-left">
                            ...
                            <h1 className="text-4xl md:text-6xl font-black mb-6 leading-tight">
                                Tech Savings <br />
                                <span className="text-orange-950">Like Never Before</span>
                            </h1>
                            <p className="text-orange-50 text-lg md:text-xl mb-10 max-w-lg leading-relaxed">
                                Get up to 60% off on premium smartphones, laptops, and audio gear. Limited time only!
                            </p>

                            <div className="flex flex-wrap justify-center md:justify-start gap-4">
                                <div className="bg-white/10 backdrop-blur-lg border border-white/20 p-4 rounded-2xl flex flex-col items-center min-w-[100px]">
                        ...
                        <div className="flex-1 relative">
                            <div className="w-[300px] h-[300px] md:w-[450px] md:h-[450px] bg-orange-400/30 rounded-full absolute -top-10 -right-10 blur-3xl" />
                            <img
            ...
            <section className="max-w-7xl mx-auto px-6 -mt-10 relative z-20">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                        ...
                        <div key={idx} className={`bg-gradient-to-br ${coupon.color} p-8 rounded-3xl text-white shadow-xl relative overflow-hidden group`}>
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="flex items-center justify-between bg-white/20 backdrop-blur-md rounded-xl p-3 border border-white/30">
                                    <span className="font-mono font-bold tracking-widest">{coupon.code}</span>
                                    <button className="text-[11px] font-black uppercase tracking-tighter bg-white text-gray-900 px-3 py-1.5 rounded-lg">Copy</button>
                                </div>
                            </div>
                        </div>
                    ))}
            ...
            <section className="max-w-7xl mx-auto px-6 py-20">
                <div className="flex items-end justify-between mb-12">
                    ...
                    <Link href="/Home/category/smartphones" className="flex items-center gap-2 text-sm font-bold text-orange-600 hover:text-orange-700 transition-colors group">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    {loading ? (
                        ...
                        deals.map((p, i) => (
                            <div key={i} className="bg-white rounded-3xl border border-gray-100 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
                                <div className="aspect-[4/3] relative overflow-hidden bg-[#f0f9ff]">
                                    ...
                                    <div className="absolute top-4 left-4 bg-red-500 text-white text-[10px] font-bold px-2 py-1 rounded uppercase">-{Math.round((1 - p.price / p.oldPrice) * 100)}%</div>
                                </div>
                                <div className="p-6">
                                    <h3 className="text-lg font-bold text-gray-900 mb-4 truncate">{p.title}</h3>
                                    <div className="flex items-center justify-between">
                                        <div className="flex flex-col">
                                            <span className="text-2xl font-black text-[#0f172a]">${p.price}</span>
                                            <span className="text-xs text-gray-400 line-through">${p.oldPrice.toFixed(0)}</span>
                                        </div>
                                        <Link href={`/product/${p.id}`} className="w-10 h-10 rounded-xl bg-orange-600 text-white flex items-center justify-center shadow-lg shadow-orange-600/20 hover:bg-orange-700 transition-colors">
                                            <ShoppingBag size={18} />
                                        </Link>
                                    </div>
                                </div>
            ...
            <section className="max-w-7xl mx-auto px-6 pb-20">
                <div className="bg-[#0f172a] rounded-[40px] p-8 md:p-16 relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-orange-500/20 blur-[100px] rounded-full translate-x-1/2 -translate-y-1/2" />
                    <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
                        <div className="flex-1 text-center md:text-left">
                            <h2 className="text-3xl md:text-4xl font-black text-white mb-6 uppercase tracking-tight">Become a TechFlow Elite</h2>
                            <p className="text-slate-400 text-lg mb-10 max-w-lg leading-relaxed">
                                Join our membership program to unlock early access to sales, free shipping, and exclusive member-only pricing.
                            </p>
                            <button className="px-10 py-5 bg-orange-600 text-white font-black rounded-2xl shadow-xl shadow-orange-600/30 hover:bg-orange-700 transition-all hover:-translate-y-1 active:translate-y-0">
                                JOIN NOW — IT'S FREE
                            </button>
                        </div>
                        <div className="flex-1 grid grid-cols-2 gap-4">
                            {[
                                ...
                                <div key={i} className="bg-white/5 border border-white/10 p-6 rounded-[32px] hover:bg-white/10 transition-colors">
